...
export const checklistItems: ChecklistItem[] = [
  ...
  },
  {
    ...
    severity: 'critical',
    severityNote: 'Auto-reject',
    tip: 'The submission form verifies credentials during submission.',
  },
  {
    id: 'package-06',
    category: 'Package & Test Org',
  ...
  // ── Documentation ──
  {
    ...
    title: 'Architecture and data flow diagram',
    subtitle: 'Describe how data moves through your system and what security measures protect it.',
    details: [
      'Provide a document describing data flows, integrations, and security measures',
      'Include what data is stored where (Salesforce vs external)',
      'Document all integration points and authentication methods',
      'Include test instructions for the review team',
      'Visual diagrams are preferred over text-only descriptions',
    ],
    howTo: [
      'Create a document (PDF or Word) with a visual diagram showing all system components',
      'Label data flows: what data moves between Salesforce, your external services, and end users',
